  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#121210]">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20">
        ...
        {/* Problem */}
        <div className="mb-16">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">The Problem</h2>
        ...
        {/* Solution */}
        <div className="mb-16">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">The Solution</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            I used Claude Code to build a Node.js automation workflow that:
          </p>
          <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6 ml-4">
            <li>
          ...
          <div className="bg-gray-50 dark:bg-[#1a1918] p-6 rounded-lg mb-6">
            <p className="font-mono text-sm text-gray-700 dark:text-gray-300 mb-4">
              <strong>Workflow:</strong>
            </p>
            <code className="block text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
              Job Spec (Markdown)
              <br />
              ↓
              <br />
        ...
        {/* Tech Stack */}
        <div className="mb-16">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">Tech Stack</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 bg-gray-50 dark:bg-[#1a1918] rounded-lg">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Automation</h3>
            ...
            <div className="p-6 bg-gray-50 dark:bg-[#1a1918] rounded-lg">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Workflow</h3>
              <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-2">
                <li>
        ...
        {/* Results */}
        <div className="mb-16">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">Results</h2>
          <div className="space-y-4 mb-6">
            <div className="p-6 bg-gray-50 dark:bg-[#1a1918] rounded-lg">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Time Saved Per Application</p>
              <p className="text-2xl font-semibold text-accent">
                45–60 mins → 10 mins
              </p>
            </div>
            <div className="p-6 bg-gray-50 dark:bg-[#1a1918] rounded-lg">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Applications Completed</p>
              <p className="text-2xl font-semibold text-accent">
                50+ roles across 8 sectors
              </p>
            </div>
            <div className="p-6 bg-gray-50 dark:bg-[#1a1918] rounded-lg">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Iteration Speed</p>
              <p className="text-2xl font-semibold text-accent">
        ...
        <div className="mb-16 border-t border-gray-200 dark:border-gray-800 pt-16">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">What This Says About Me As a Product Manager</h2>
        ...
        {/* Lesson */}
        <div className="mb-16 bg-gray-50 dark:bg-[#1a1918] p-8 rounded-lg border border-gray-200 dark:border-gray-800">
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-16">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">Try the Tool</h2>
